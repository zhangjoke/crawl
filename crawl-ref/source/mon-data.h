...

{
    ...
    M_SEE_INVIS | M_UNBLINDABLE | M_WARM_BLOOD | M_NO_POLY_TO | M_SPEAKS
        | M_BATTY | M_FLIES,
    mrd(MR_RES_FIRE, 2),
    8, MONS_BAT, MONS_FIRE_BAT, MH_NONLIVING, 10,
    { {AT_BITE, AF_HELL_HUNT, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 395,
...
{
    MONS_KOBOLD_BOMBARDIER, 'K', CYAN, "kobold bombardier",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    7, MONS_KOBOLD, MONS_KOBOLD, MH_NATURAL, 20,
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 420,
    4, 15, MST_KOBOLD_BOMBARDIER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, SPELL_ENERGY(15),
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_KOBOLD_BOMBARDIER}, TILE_ERROR
},
